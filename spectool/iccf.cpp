...
auto iccf_mc_spec(const VEC& w1,
                  const VEC& f1,
                  const VEC& err1,
                  const VEC& w2,
                  const VEC& f2,
...
py::array_t<double> numpy_iccf(const VEC& w1,
                               const VEC& f1,
                               const VEC& w2,
                               const VEC& f2,
                               const VEC& shift) {
...
auto numpy_iccf_mc(const VEC& w1,
                   const VEC& f1,
                   const VEC& err1,
                   const VEC& w2,
                   const VEC& f2,
...
py::array_t<double> numpy_iccf_spec(const VEC& w1,
                                    const VEC& f1,
                                    const VEC& w2,
                                    const VEC& f2,
                                    const VEC& shift) {
