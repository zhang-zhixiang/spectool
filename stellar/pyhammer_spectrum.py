...
class Spectrum(object):
    ...
    def __init__(self):
        ...
        self.pyhammer_data_path = os.environ['PYHAMMER_DATA_PATH']

        # Store the SB2 filenames and order for access later
        SB2ListPath = os.path.join(self.pyhammer_data_path, 'list_of_SB2_temps.txt')
        ...
        #
        pklPath = os.path.join(self.pyhammer_data_path, 'tempLines_2020-06-16.pickle')
    ...
    def readSpec(self, wave, flux, error):
    ...
    def isWD(self):
        ...
        arg = np.isfinite(interp_flux)
        ftemp = interp_flux[arg]
        if len(ftemp) < 1:
            return False, np.nan
    ...
    def getFullTempName(self):
        ...
        path = os.path.join(self.pyhammer_data_path, 'templates/')
        path_SB2 = os.path.join(self.pyhammer_data_path, 'templates_SB2/')
        ...
        #Spectral type SB2
            ...
            return path_SB2 + os.sep + tempName
            # return np.nan
        elif bestGuess['specType'] == -1:
            return np.nan
